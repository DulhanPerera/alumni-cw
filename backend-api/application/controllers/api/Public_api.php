...
// Public API endpoints for external alumni data access.

/**
 * Public API controller for client applications.
 *
...
class Public_api extends MY_Controller
{
    ...
    public function featured_today()
    {
        ...
        // Mobile AR App permission only
        $this->require_api_scope('read:alumni_of_day');
        ...
        return $this->json_response([
            ...
            'data' => [
                ...
                'featured_alumnus' => [
                    ...
                    'profile_image' => !empty($featured['profile_image'])
                        ? base_url($featured['profile_image'])
                        : null,
